...
A better solution would be to just stop the message and start anew. This can be done with http2's RST\_STREAM frame which will help prevent wasted bandwidth and the need to tear down connections.
